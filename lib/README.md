...
| Origin | Files |
|---|---|
| CPython, unmodified | `abc.py`, `ast.py`, `_collections_abc.py`, `collections/abc.py`, `contextlib.py`, `copyreg.py`, `enum.py`, `functools.py`, `genericpath.py`, `os.py`, `posixpath.py`, `re/`, `reprlib.py`, `selectors.py`, `socket.py`, `stat.py`, `struct.py`, `types.py` |
