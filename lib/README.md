...
| Origin | Files |
|---|---|
| CPython, unmodified | `abc.py`, `ast.py`, `bisect.py`, `codecs.py`, `_collections_abc.py`, `collections/`, `_compat_pickle.py`, `contextlib.py`, `copyreg.py`, `enum.py`, `functools.py`, `genericpath.py`, `heapq.py`, `keyword.py`, `operator.py`, `os.py`, `pickle.py`, `posixpath.py`, `random.py`, `re/`, `reprlib.py`, `selectors.py`, `socket.py`, `stat.py`, `string.py`, `struct.py`, `types.py`, `warnings.py` |
| Generated from CPython | `_ast.py` |
| CPython, modified for apython | `__future__.py`, `copy.py`, `io.py`, `unittest/`, `test/` |
